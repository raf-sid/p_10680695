...
//\   This prints out all the available options in the DB
   cout << "\nAvailable operations: \n1. Add New Students\n2."
        << "Student Login\n3. Faculty Login\n4. Proctor Login\n5. Admin View\n"
        << "6. Exit\n Please option number must not exceed 6 and not less than 1.\n Enter option: ";
    cin >> option;

    if(option == 1){
    cout << "Enter the number of the new student falls on : ";
    cin >> n;
    ...
    for (int i = 0;i < n;i++){
        ...
        cout << "Enter registration number of new student : ";
        cin >> data;
        outfile << data << "\t";
        ...
        char regno[9];
        cout << "Enter your student registration number: ";
        cin >> regno;
        ifstream infile;
        int check = 0;
    ...
    //This loop acts as an admin view to see all the data in the file.
        ...
        cout << "Option number must not be less than 1!";

    else if(option>=7)
        cout << "Option number must not be greater than 6!";

    else if (option==6)
        cout << "You are exiting this application, BYE!";
